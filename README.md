...
This Repository contains several files that may help newcomers to our Lab.

## General Research Advice

The following are general research advice that I found very helpful (adopted from [Prof. Xuanzhe Liu](liuxuanzhe.com))
